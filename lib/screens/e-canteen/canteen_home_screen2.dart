...
import 'package:peoplepro/screens/e-canteen/meal_card_screen2.dart';
import 'package:peoplepro/screens/e-canteen/meal_closing_screen2.dart';
...
class CanteenHomeScreen2 extends StatefulWidget {
  const CanteenHomeScreen2({Key? key}) : super(key: key);

  @override
  State<CanteenHomeScreen2> createState() => _CanteenHomeScreen2State();
}

class _CanteenHomeScreen2State extends State<CanteenHomeScreen2> {
  ...
  Future<bool> login() async {
    ...
    var response = await CanteenService2.login(
        CanteenSession.username, CanteenSession.password);
    Utils.hideLoadingIndicator(context);

    if (response == null || response.jwtToken.isEmpty) return false;
    CanteenSession.jwtToken = response.jwtToken;
    CanteenSession.isMealClosedToday = response.isMealClosedToday;
  ...
  void loadMealClosedList() async {
    _mealCloseItems =
        await CanteenService2.getMealClosedList(CanteenSession.username);
                  ...
                  child: _loggedIn
                      ? Column(
                          ...
                          children: [
                            ...
                            Visibility(
                              visible: CanteenSession.isMealClosedToday,
                              child: Container(
                                  padding: const EdgeInsets.symmetric(
