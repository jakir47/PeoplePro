...
class MealCardScreen2 extends StatefulWidget {
  const MealCardScreen2({Key? key}) : super(key: key);

  @override
  State<MealCardScreen2> createState() => _MealCardScreen2State();
}

class _MealCardScreen2State extends State<MealCardScreen2> {
