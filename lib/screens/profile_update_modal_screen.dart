...
class ProfileUpdateModalScreen extends StatefulWidget {
  final bool isModal;
  const ProfileUpdateModalScreen({Key? key, this.isModal = false})
      : super(key: key);

  @override
  State<ProfileUpdateModalScreen> createState() =>
      _ProfileUpdateModalScreenState();
}

class _ProfileUpdateModalScreenState extends State<ProfileUpdateModalScreen> {
              ...
              children: [
                ...
                ProfileUpdateTextFieldWidget(
                  ...
                  validator: ((input) => input == null ||
                          input.isEmpty ||
                          input.length != 4
                      ? "Enter a valid 4-digit IP-PABX number or use 0000 if not applicable"
                      : null),
                ),
                        ...
                        : () async {
                            ...
                            if (success) {
                              MessageBox.success(context, "Profile Update",
                                  ...
                                  onOkTapped: () async {
                                await Utils.storage.write(
                                    key: "profileComplete", value: "done");
                                Navigator.pop(context);
                              });
                            } else {
                              MessageBox.error(context, "Profile Update",
                                  "An error occurred");
                            }
                          },
